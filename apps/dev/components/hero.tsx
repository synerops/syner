  ...
  return (
    <section className="flex flex-col items-center gap-6 py-16 text-center">
      ...
      <a
        ...
        className="mt-4 inline-flex items-center gap-2 rounded-lg bg-black px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-zinc-800 dark:bg-white dark:text-black dark:hover:bg-zinc-200"
      >
        <svg
          className="h-5 w-5"
          fill="currentColor"
