...
```bash
/vaults-grow-specialist refine retrieval-optimizer
/vaults-grow-specialist refine voice-processor --add-example "Mar 5 voice memo"
```
...
```bash
/vaults-grow-specialist graduate retrieval-optimizer
/vaults-grow-specialist graduate voice-processor --force
```
...
/vaults-grow-specialist status --ready
/vaults-grow-specialist graduate [name]
```
...
→ Run `/vaults-grow-specialist audit` to check overlap
