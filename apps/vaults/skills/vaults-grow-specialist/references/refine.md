...
```bash
/vaults-grow-specialist refine [proposal-name]
/vaults-grow-specialist refine retrieval-optimizer
/vaults-grow-specialist refine retrieval-optimizer --add-example "Mar 5 search failure"
/vaults-grow-specialist refine retrieval-optimizer --scope "vocabulary mapping across vaults"
```
...
[If ready:]
Run `/vaults-grow-specialist graduate [name]` to promote.
```
...
Run `/vaults-grow-specialist graduate [name]`
