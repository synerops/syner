...
/vaults-grow-specialist review --type retrieval
/vaults-grow-specialist review --dry-run
```
...
Read `.syner/ops/vaults-grow-specialist/observations.md`
...
Location: `.syner/ops/vaults-grow-specialist/proposals/[name].md`
...
Add to `.syner/ops/vaults-grow-specialist/tracking.md`:
