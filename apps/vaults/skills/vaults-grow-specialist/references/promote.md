...
- It's needed in almost every session
...
```bash
/vaults-grow-specialist promote [specialist-name]
/vaults-grow-specialist promote retrieval-optimizer
/vaults-grow-specialist promote retrieval-optimizer --force
/vaults-grow-specialist promote retrieval-optimizer --dry-run
```
...
Read from `.syner/artifacts/vaults-grow-specialist/specialists/[name].md`
...
Location: `apps/vaults/agents/[name].md`
...
evolved_from: .syner/artifacts/vaults-grow-specialist/specialists/[name].md
promotion_date: [date]
...
Evolved through vaults-grow-specialist:
- L0 Observation: [date]
- L1 Proposal: [date]
- L2 Specialist: [date]
- L3 Subagent: [date]
...
[What this subagent knows about the user that generic agents don't]
...
*Promoted: [date] | Origin: vaults-grow-specialist*
```

### 4. Update Notes Agent

Add to `apps/vaults/agents/notes.md` skill list if appropriate, or document in specialist team section.
...
```bash
ln -s ../apps/vaults/agents/[name].md .claude/agents/[name]
```
...
**Specialist:** [name]
**Would create:** `apps/vaults/agents/[name].md`
...
- Create: `apps/vaults/agents/[name].md`
- Archive: `.syner/artifacts/vaults-grow-specialist/specialists/[name].md`
- Symlink: `.claude/agents/[name]`
...
Potential overlap with: agency-[generic-name]
...
The custom subagent knows your specific patterns.

Add to tracking:
```markdown
## Deprecated Generics (for apps/vaults)
