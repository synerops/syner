...
/vaults-grow-specialist status [specialist-name]
/vaults-grow-specialist status --level L1
/vaults-grow-specialist status --ready
/vaults-grow-specialist status --stats
```
...
Gather from:
- `.syner/ops/vaults-grow-specialist/observations.md` (L0)
- `.syner/ops/vaults-grow-specialist/proposals/` (L1)
- `.syner/artifacts/vaults-grow-specialist/specialists/` (L2)
- `apps/vaults/agents/` (L3, check for evolved_from)
- `.syner/ops/vaults-grow-specialist/tracking.md` (metrics)
...
Run `/vaults-grow-specialist review`
...
|------|--------------|--------|
| [type] | [N] | `/vaults-grow-specialist review --type [type]` |

### Ready for Graduation (L1 → L2)

| Proposal | Consultations | Action |
|----------|---------------|--------|
| [name] | [N] | `/vaults-grow-specialist graduate [name]` |

### Ready for Promotion (L2 → L3)

| Specialist | Interactions | Action |
|------------|--------------|--------|
| [name] | [N] | `/vaults-grow-specialist promote [name]` |
...
- Add observation: `/vaults-grow-specialist observe`
- Review patterns: `/vaults-grow-specialist review`
- See details: `/vaults-grow-specialist status [name]`
- Full stats: `/vaults-grow-specialist status --stats`
```
