...
/vaults-grow-specialist observe --type capture --context "voice memo while driving"
```
...
Location: `.syner/ops/vaults-grow-specialist/observations.md`
...
Run `/vaults-grow-specialist review` when you have 3+ of a type.
```
...
```
/vaults-grow-specialist observe --type capture
...
```
/vaults-grow-specialist observe --type linking
...
[If type has 3+:]
Pattern detected in [type]. Run `/vaults-grow-specialist review` to analyze.
```
