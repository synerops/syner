...
```bash
/notes-grow-specialist graduate [proposal-name]
/notes-grow-specialist graduate retrieval-optimizer
/notes-grow-specialist graduate retrieval-optimizer --force
/notes-grow-specialist graduate retrieval-optimizer --dry-run
```
...
Location: `.syner/artifacts/notes-grow-specialist/specialists/[name].md`
...
Move proposal to `.syner/ops/notes-grow-specialist/archive/`
...
In `.syner/ops/notes-grow-specialist/tracking.md`:
...
`.syner/artifacts/notes-grow-specialist/specialists/[name].md`

### Archived

`.syner/ops/notes-grow-specialist/archive/[name].md`
...
Run `/notes-grow-specialist status [name]` to see current state.
```
...
1. Continue refining (recommended)
   `/notes-grow-specialist refine [name]`

2. Force graduation (not recommended)
   `/notes-grow-specialist graduate [name] --force`
...
**Proposal:** [name]
**Would create:** `.syner/artifacts/notes-grow-specialist/specialists/[name].md`
