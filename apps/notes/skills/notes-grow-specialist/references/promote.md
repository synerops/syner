...
```bash
/notes-grow-specialist promote [specialist-name]
/notes-grow-specialist promote retrieval-optimizer
/notes-grow-specialist promote retrieval-optimizer --force
/notes-grow-specialist promote retrieval-optimizer --dry-run
```
...
Read from `.syner/artifacts/notes-grow-specialist/specialists/[name].md`
...
Location: `apps/notes/agents/[name].md`
...
evolved_from: .syner/artifacts/notes-grow-specialist/specialists/[name].md
promotion_date: [date]
...
Evolved through notes-grow-specialist:
- L0 Observation: [date]
- L1 Proposal: [date]
- L2 Specialist: [date]
- L3 Subagent: [date]
...
*Promoted: [date] | Origin: notes-grow-specialist*
```

### 4. Update Notes Agent

Add to `apps/notes/agents/notes.md` skill list if appropriate, or document in specialist team section.
...
```bash
ln -s ../apps/notes/agents/[name].md .claude/agents/[name]
```
...
**Specialist:** [name]
**Would create:** `apps/notes/agents/[name].md`
...
- Create: `apps/notes/agents/[name].md`
- Archive: `.syner/artifacts/notes-grow-specialist/specialists/[name].md`
...
Add to tracking:
```markdown
## Deprecated Generics (for apps/notes)
