...
```
apps/notes/vaults/           # Your notes
apps/*/vaults/               # Other apps can have vaults too
```

Discovery pattern: `apps/*/vaults/**/*.md`
...
3. Symlink:
   ```bash
   ln -sf ../../../apps/notes/skills/{name} .claude/skills/{name}
   ```

## How skills read vaults

1. Use Glob to find notes: `apps/*/vaults/**/*.md`
