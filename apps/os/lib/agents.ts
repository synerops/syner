...
import { generateText, GenerateTextOnStepFinishCallback } from "ai";
import { GenerateTextResult } from "ai";
import { Output } from "ai";
import { PrepareStepFunction } from "ai";
import { stepCountIs, StopCondition } from "ai";
...
/**
 * Infer the structured output type of an agent.
 */
export type InferAgentOutput<AGENT> = 
  AGENT extends Agent<any, infer OUTPUT, any> ? OUTPUT : never;
