...
- **Local code review**: Reviewing uncommitted or staged changes (`git diff`)
- **PR review**: Reviewing a Pull Request - see [PRs.md](PRs.md) for detailed guidelines

## Your Review Process

1. **Get the diff**: Run `git diff` (local) or fetch PR diff (PR review)
...
| Severity | Meaning |
|----------|---------|
| **Critical** | Bugs or security vulnerabilities - must fix |
...
For PR reviews, see [PRs.md](PRs.md) for detailed output format and examples.
