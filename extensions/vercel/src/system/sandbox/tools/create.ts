...
import type { Sandbox, CreateSandboxOptions } from '@syner/sdk'
...
type CreateSandboxResult =
  | { message: string; sandbox: Sandbox | null; reused?: boolean }
  | { message: string; sandbox: Sandbox; reused: true }
...
The tool will return a 'reused: true' flag if an existing sandbox was found and reused.`,
    ...
    execute: async (_args: z.infer<typeof createSandboxInputSchema>): Promise<CreateSandboxResult> => {
      console.log('═══════════════════════════════════════════════════════════')
